...
- **producer_flow**: (KGR) 5. DTF_CALC_MIS
- **used_by_workbooks**: ['(KGR) BRD.BC03-04-05_SFC ước tính_SFC thực tế_ MIS']
- **physical_tables**: []

## Cột
### %GP Ròng
- formula: `IFnull("%LN Gộp",0) - IFnull("CKKM",0)`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_CREDIT_LINES_F.QUANTITY', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.QUANTITY', 'DW_NS_X_GIA_VON_MUC_TIEU_CT.CUSTRECORD_SCV_GVMT_LINE_GVMT_SP', 'DW_NS_X_GIA_VON_TON_KHO.CUSTRECORD_SCV_GVTK_UNIT_COST_L', 'DW_NS_X_TRADE_PROMOTION_LINE.CKKM']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_CREDIT_LINES_F.QUANTITY', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.QUANTITY', 'DW_NS_X_GIA_VON_MUC_TIEU_CT.CUSTRECORD_SCV_GVMT_LINE_GVMT_SP', 'DW_NS_X_GIA_VON_TON_KHO.CUSTRECORD_SCV_GVTK_UNIT_COST_L']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_TRADE_PROMOTION_LINE.CKKM']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
- shown_as: ['CKKM @(KGR) BRD.BC03-04-05_SFC ước tính_SFC thực tế_ MIS']

### CP CKKM
- formula: `"Doanh thu thực tế" *"CKKM"`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_TRADE_PROMOTION_LINE.CKKM']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Chiết khấu
- formula: `Case When "Transaction Type"  like 'Invoice'then Ifnull("CP CKKM",0) Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_TRADE_PROMOTION_LINE.CKKM']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Chiết khấu trả lại
- formula: `Case When "Transaction Type"  like 'Credit Memo' then -Ifnull("CP CKKM",0) Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_TRADE_PROMOTION_LINE.CKKM']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_CAM_CUSTOMRECORD_CSEG_SCV_NHOMXANHDO.ID XD', 'DW_NS_X_CUST_CREDIT_LINES_SUPPLEMENTARY.TAX1AMT', 'DW_NS_X_CUST_INVOICE_LINES_SUPPLEMENTARY_1.TAX1AMT']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- formula: `sum( ... )`
- aggregation: sum
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_CUST_CREDIT_LINES_SUPPLEMENTARY.TAX1AMT', 'DW_NS_X_CUST_INVOICE_LINES_SUPPLEMENTARY_1.TAX1AMT']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_CAM_CUSTOMLIST_SCV_QUY_HOACH_SP.Quy hoạch SP']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- formula: `sum( ... )`
- aggregation: sum
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
- shown_as: ['Doanhthuthct @(KGR) BRD.BC03-04-05_SFC ước tính_SFC thực tế_ MIS']

### Doanh thu trả lại
- formula: `Case When "Transaction Type"  like 'Credit Memo' then -"Doanh thu thực tế" Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Doanh thu xuất bán
- formula: `Case When "Transaction Type"  like 'Invoice' then "Doanh thu thực tế" Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Giá bán TB
- formula: `Case When "Transaction Type"  like 'Invoice' then - "Đơn Giá (-VAT)" Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_CREDIT_LINES_F.QUANTITY', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.QUANTITY']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
- shown_as: ['GibnTB @(KGR) BRD.BC03-04-05_SFC ước tính_SFC thực tế_ MIS']

### Giá trả lại TB
- formula: `Case When "Transaction Type"  like 'Credit Memo' then -"Đơn Giá (-VAT)" Else 0 End`
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_CREDIT_LINES_F.QUANTITY', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.QUANTITY']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### ID Kênh
- formula: `UNION(...)`
- physical_roots: ['DW_NS_X_SALE_CHANNEL.ID']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Mã KH
- formula: `UNION(...)`
- physical_roots: ['DW_NS_CUSTOMER_D.ALTNAME']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
### Phân nhóm SP
- formula: `UNION(...)`
- physical_roots: ['DW_NS_X_CAM_CUSTOMLIST_SCV_PRODUCT_SOURCE.NAME', 'DW_NS_X_CAM_CUSTOMLIST_SCV_PRODUCT_SOURCE.Phân nhóm SP']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- formula: `sum( ... )`
- aggregation: sum
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_X_GIA_VON_MUC_TIEU_CT.CUSTRECORD_SCV_GVMT_LINE_GVMT_SP', 'DW_NS_X_GIA_VON_TON_KHO.CUSTRECORD_SCV_GVTK_UNIT_COST_L']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- formula: `sum( ... )`
- aggregation: sum
- physical_roots: ['DW_NS_X_CUST_CREDIT_LINES_SUPPLEMENTARY.TAX1AMT', 'DW_NS_X_CUST_INVOICE_LINES_SUPPLEMENTARY_1.TAX1AMT']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
...
- physical_roots: ['DW_NS_CUSTOMER_CREDIT_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_CREDIT_LINES_F.QUANTITY', 'DW_NS_CUSTOMER_INVOICE_LINES_F.BASE_REVENUE', 'DW_NS_CUSTOMER_INVOICE_LINES_F.QUANTITY', 'DW_NS_X_CUST_CREDIT_LINES_SUPPLEMENTARY.TAX1AMT', 'DW_NS_X_CUST_INVOICE_LINES_SUPPLEMENTARY_1.TAX1AMT']
- filters: ['"ISINACTIVE" IN(\'F\')', '("Is Công ty con Chi nhánh Invoice" IS NULL or "Is Công ty con Chi nhánh Invoice" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\') and "ISPOSTING" IN(\'T\')', '"Is Công ty con Chi nhánh Memo" IN(\'F\') and ("Is Công ty con Chi nhánh Memo" IS NULL or "Is Công ty con Chi nhánh Memo" NOT IN(\'T\'))', '"ISPOSTING" IN(\'T\') and "ACCTTYPE" IN(\'Income\', \'OthCurrLiab\')', '"ACCTTYPE" IN(\'Income\')', '(1 = 1)']
- joins: ['leftouterjoin: ID = ID, TRANSACTION = TRANSACTION', 'rightouterjoin: GVMT_LINE_MSP = ITEM, Month Key = Month Key', 'leftouterjoin: ITEM = GVTK_ITEM_CODE_L, POSTINGPERIOD - 1 = GVTK_PERIOD_L, SUBSIDIARY = GVTK_SUBSIDIARY_L', 'leftouterjoin: Tên Chuỗi = Chuỗi, Model name = Model, POSTINGPERIOD = CUSTRECORD_SCV_PRO_DIS_PERIOD']
- shown_as: ['ĐƠN GIÁ (+VAT) @(KGR) BRD.BC03-04-05_SFC ước tính_SFC thực tế_ MIS']
