...
- filters: ['(1 = 1)', '"ACCTTYPE" IN(\'Income\')', '"CUSTBODY_SCV_AOP_LOAI_BAO_CAO" between 3 and 3 and "Chỉ tiêu (AOP)" between 1 and 200']
- joins: ['rightouterjoin: PERIODNAME = PERIODNAME, TRANDATE <= AsOfDate, ID CLASS = ID CLASS', 'leftouterjoin: PERIODNAME = PERIODNAME, AsOfDate = AsOfDate', 'leftouterjoin: PERIODNAME = PERIODNAME, ID CLASS = CLASS', 'leftouterjoin: PERIODNAME = PERIODNAME', 'leftouterjoin: _k = _k']
