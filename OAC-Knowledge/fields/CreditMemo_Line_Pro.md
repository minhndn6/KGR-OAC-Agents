...
- **type**: db_dataset
- **grain**: line-level (credit-memo transaction line extension + promotion)  ()
- **producer_flow**: 
- **used_by_workbooks**: None
- **physical_tables**: ['DW_NS_X_CAM_CUSTCREDTRANSACTIONLINEEXTENSION', 'DW_NS_X_CAM_CUSTOMRECORD_CSEG_SCV_SG_PRO']
